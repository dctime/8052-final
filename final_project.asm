...
STARTWRITELCDMODEEDIT:
  MOV 046H, #0
CHECKWRITELCDMODEEDIT:
  MOV A, 046H
  MOVC A, @A+DPTR
  CJNE A, #0, WRITEDATATOLCDMODEEDIT
  JMP ENDWRITEDATATOLCDMODEEDIT
WRITEDATATOLCDMODEEDIT:
  CALL USEASETTINGDATA
  INC 046H
  JMP CHECKWRITELCDMODEEDIT
ENDWRITEDATATOLCDMODEEDIT:
  JMP INITCURSOR
LCDINITTEXT:
  DB "Edit Mode", 0
INITCURSOR:
...
LITUPCHECK0:
  CJNE A, #00000001, LITUPCHECK1
  SETB 090H
  JMP ENDLITUPFILLIN
LITUPCHECK1:
  CJNE A, #00000010, LITUPCHECK2
  SETB 091H
  JMP ENDLITUPFILLIN
LITUPCHECK2:
  CJNE A, #00000100, LITUPCHECK3
  SETB 092H
  JMP ENDLITUPFILLIN
LITUPCHECK3:
  CJNE A, #00001000, LITUPCHECK4
  SETB 093H
  JMP ENDLITUPFILLIN
LITUPCHECK4:
  CJNE A, #00010000, LITUPCHECK5
  SETB 094H
  JMP ENDLITUPFILLIN
LITUPCHECK5:
  CJNE A, #00100000, LITUPCHECK6
  SETB 095H
  JMP ENDLITUPFILLIN
LITUPCHECK6:
  CJNE A, #01000000, ENDLITUPFILLIN
  SETB 096H
  JMP ENDLITUPFILLIN
...
CYCLEIDENTIFYBITALIVEORDEADGETROW:
  // TODO: find if alive or dead not neighbor
  MOV A, @R0
  ANL A, 038H
...
CHANGESEQUENCENOT4:
  ...
  JMP ENDCHANGESEQUENCE
CHANGESEQUENCENOT5:
  CJNE A, #6, CHANGESEQUENCENOT6
  // 6
  MOV DPTR, #BUZZERSEQUENCETABLE3
  JMP ENDCHANGESEQUENCE
CHANGESEQUENCENOT6:
  // 7
  MOV DPTR, #BUZZERSEQUENCETABLE7
  JMP ENDCHANGESEQUENCE
