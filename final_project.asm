...
BUZZERSEQUENCETABLE1:
  ...
  DB 26, 26, 26, 26, 26, 26, 25, 25, 25, 25, 25, 25
  DB 26, 26, 26, 26, 26, 26, 29, 29, 29, 29, 29, 29
...
BUZZERSEQUENCETABLE2:
  ...
  DB 15, 15, 15, 15, 15, 15, 1, 1, 1, 1, 1, 1
  DB 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15
  DB 15, 15, 15, 15, 15, 15, 13, 13, 13, 13, 13, 13
  DB 18, 18, 18, 18, 18, 18, 17, 17, 17, 17, 17, 17
  DB 15, 15, 15, 15, 15, 15, 1, 1, 1, 1, 1, 1
...
CHANGESEQUENCECHECK1:
  JNB 008H, CHANGESEQUENCECHECK2
  INC 043H
CHANGESEQUENCECHECK2:
  JNB 010H, CHANGESEQUENCECHECK3
  INC 043H
CHANGESEQUENCECHECK3:
  JNB 018H, CHANGESEQUENCECHECK4
  INC 043H
CHANGESEQUENCECHECK4:
  JNB 00FH, CHANGESEQUENCECHECK5
  INC 043H
CHANGESEQUENCECHECK5:
  JNB 017H, CHANGESEQUENCECHECK6
  INC 043H
CHANGESEQUENCECHECK6:
  JNB 01FH, CHANGESEQUENCE
  INC 043H
CHANGESEQUENCE:
  MOV A, 043H
