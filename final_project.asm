...
CYCLECHECKNEIGHBORIDINVALID:
  ...
  JMP CYCLENEXTROW
// temp function for neighbor for RL
CYCLEPUTAINTO03AH:
  CJNE A, #00100000B, CYCLENORMALPUTAINTO03AH
  MOV 03AH, #00000001B
  RET
CYCLENORMALPUTAINTO03AH:
  MOV 03AH, A
  RET
CYCLEPUTAINTO03BH:
  CJNE A, #10000000B, CYCLENORMALPUTAINTO03BH
  MOV 03BH, #00000001B
  RET
CYCLENORMALPUTAINTO03BH:
  MOV 03BH, A
  RET
