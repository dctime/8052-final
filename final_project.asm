...
LOOPGAMEOFLIFE:
  CALL SCANLED
  CALL KEYBOARD
LOOPGAMEOFLIFECHECKRESET:
  JNB 053H, ENDOFLOOPGAMEOFLIFE
  // reset code
  JMP START
ENDOFLOOPGAMEOFLIFE:
  JMP LOOPGAMEOFLIFE
...
KEYBOARDNOT0:
  ...
  // 1
  JNB 052H, KEYBOARDNOT0EDITMODE
  // game of life mode
  JMP AFTERKEYBOARD
KEYBOARDNOT0EDITMODE:
...
KEYBOARDNOT2:
  ...
  // 3
  JNB 052H, KEYBOARDNOT2EDITMODE
  // game of life mode
  JMP AFTERKEYBOARD
KEYBOARDNOT2EDITMODE:
  // test - set C High
  SETB TR1
  MOV A, #7
...
KEYBOARDNOT3:
  ...
  // 4
  JNB 052H, KEYBOARDNOT3EDITMODE
  // game of life mode
  JMP AFTERKEYBOARD
KEYBOARDNOT3EDITMODE:
...
KEYBOARDNOT4:
  ...
  // 5
  JNB 052H, KEYBOARDNOT4EDITMODE
  JMP AFTERKEYBOARD
KEYBOARDNOT4EDITMODE:
  // dont blink
  CPL 051H
CHECKBLINKUPDATELCDINFO:
  MOV A, #11001000B
  CALL USEATOCOMMANDLCD
  JNB 051H, NOBLINKUPDATELCDINFO
BLINKUPDATELCDINFO:
  MOV A, #66
  JMP BLINKUPDATINGLCDINFO
NOBLINKUPDATELCDINFO:
  MOV A, #32
BLINKUPDATINGLCDINFO:
...
KEYBOARDNOT5:
  ...
  // 6
  JNB 052H, KEYBOARDNOT5EDITMODE
  // game of life mode
  JMP AFTERKEYBOARD
KEYBOARDNOT5EDITMODE:
...
KEYBOARDNOT8:
  ...
  // 9
  JNB 052H, KEYBOARDNOT8EDITMODE
  // game of life mode
  JMP AFTERKEYBOARD
KEYBOARDNOT8EDITMODE:
...
KEYBOARDNOT14:
  ...
  // 15
  JNB 052H, KEYBOARDNOT14EDITMODE
  JMP AFTERKEYBOARD
KEYBOARDNOT14EDITMODE:
  JMP MODEGAMEOFLIFE
KEYBOARDNOT15:
...
CYCLECHECKVALIDATENEIGHBORID:
  MOV A, 03CH
  CJNE A, #8, TEMPCYCLEADJUSTNEIGHBORBIT
  JMP CYCLECHECKNEIGHBORIDINVALID
TEMPCYCLEADJUSTNEIGHBORBIT:
  JMP CYCLEADJUSTNEIGHBORBIT
...
DISPLAYSCORE:
  ...
  CALL USEATOCOMMANDLCD
  MOV R0, #04FH
DISPLAYSCORENEXTNUMBER:
  INC R0
  MOV A, @R0
  ADD A, #48
  CALL USEASETTINGDATA
  MOV A, R0
  CJNE A, #054H, DISPLAYSCORENEXTNUMBER
  JMP DISPLAYDELTASCORE
...
CHANGESEQUENCENOT1:
  ANL A, #10000000B
  CJNE A, #00000000B, CHANGESEQUENCENOT2
  // 1+
...
SCORECARRYCHECKAMINUS:
  MOV B, A
  SUBB A, #10
  JC ENDSCORECARRYCHECK // if cannot minus 10
  INC @R1
...
TURN1LOCINTONUMBER:
  PUSH 000H // R0
  MOV R0, #0
TURN1LOCINTONUMBERCHECKA:
  CJNE A, #00000001B, TURN1LOCINTONUMBERNEXTITERATION
  MOV A, R0
  POP 000H // R0
  RET
TURN1LOCINTONUMBERNEXTITERATION:
  RR A
  INC R0
  JMP TURN1LOCINTONUMBERCHECKA
